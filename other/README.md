...
We used the preprocessed data given in the folder [UG-roh_nachkorrigiert](UG/UG-roh_nachkorrigiert). We used the corridor with a width of 180cm and a person number between 15 and 230. The files are labeled: ug-[width]-[#people].txt 
...
In all datasets 400 people are walking thrugh a bottleneck with a width of 240-500 cm. We used the [ao-360-400_combine.txt](AO/ao-360-400_combine.txt) for the final tests.